...
wb = wandb.init(
        ...
        notes="single-epoch, symmetric loss, 1000 samples, using diff projection heads for neg and pos and no batch norm, original simclr",
        save_code=True,
        entity="sleep-staging",
        name="single-epoch-contrastive-loss-t-100, same_all_diff_pj",
    )
